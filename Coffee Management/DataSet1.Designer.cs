...
SELECT ID, CheckIn, CheckOut, TableID, Discount, TotalPrice, Status FROM Bill WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GUI.Properties.Settings.Default.CoffeeManagementConnectionString2;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "select ID,CheckIn,CheckOut,TableID,Discount,TotalPrice,Status from bill";
        ...
        public virtual int FillBy(DataSet1.BillDataTable dataTable) {
